              ...
              <form action="" method="POST" class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="kode_lab" class="form-control" value="<?= $view['kode_lab']?>" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Lab</label>
                    <div class="col-sm-9">
                      <input type="text" name="nama_lab" class="form-control" value="<?= $view['nama_lab']?>" >
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Peminjam</label>
                    <div class="col-sm-9">
                      <input type="text" name="nama_peminjam" class="form-control" value="<?= $view['nama_peminjam']?>" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="date" name="tgl_pinjam" class="form-control" value="<?= $view['tgl_pinjam']?>" >
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                      <input type="number" name="jumlah" class="form-control" value="<?= $view['jumlah']?>" required>
                    </div>
                  </div>
